...
export default async function Home() {
  ...
  return (
    ...
    <section className="academics section" id="academics"><Reveal className="section-heading"><p className="eyebrow">Academic Journey</p><h2>Learning that meets<br />children <em>where they are.</em></h2></Reveal><div className="program-grid">{programmes.map(([number, title, age, text]) => <Reveal
  key={title}
>
  <article>
...
>
  <article>
    ...
    <section className="notices section" id="notices"><Reveal className="section-heading"><p className="eyebrow">Latest Updates</p><h2>What&apos;s happening<br /><em>at KCHS.</em></h2></Reveal><div className="notice-list">{notices.length ? notices.map((notice) => (
  <Reveal
    key={notice.id}
  >
    <article>
  ...
  <Reveal delay={80}>
    ...
    <section className="public-events section" id="events"><Reveal className="section-heading"><p className="eyebrow">School Calendar</p><h2>Upcoming events<br /><em>at KCHS.</em></h2></Reveal><div className="public-events-grid">{events.length ? events.map((event) => (
  <Reveal
    key={event.id}
  >
