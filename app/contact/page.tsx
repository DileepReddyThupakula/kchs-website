...
export default function ContactPage() {
  return <main><SiteHeader />
    ...
    <section className="contact-page-grid interior-section"><div><p className="eyebrow">Visit the school</p><h2>A local school with<br />a lasting <em>purpose.</em></h2><p className="address-copy">Vempalli Road<br />Yerraguntla, Andhra Pradesh</p><div className="map-placeholder"><span>Location</span><p>Map location will be added when the school&apos;s exact Google Maps link is available.</p></div></div><div className="contact-details"><article><span>Admissions enquiries</span><h3>Considering KCHS?</h3><p>Begin with a short enquiry and the school can share the next available information.</p><Link href="/admissions#enquiry">Begin an enquiry →</Link></article><article><span>General enquiries</span><h3>Need to get in touch?</h3><p>Contact details will be updated shortly.</p></article><article><span>School profile</span><h3>Krishna Chaitanya High School</h3><p>Established 2001 · State Board · English Medium · Nursery to Class 10</p></article></div></section>
